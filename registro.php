...
<body>
	<main>
		<h1>Registro</h1>
		<form action="php/registro_usuario_be.php" method="POST" class="formulario" id="formulario">
			<!-- Grupo: Usuario -->
			...
			<div class="formulario__grupo" id="grupo__telefono">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="telefono" id="telefono" placeholder="Numero telefonico">
					<i class="formulario__validacion-estado fas fa-times-circle"></i>
				</div>
		...
		<a href="./login.html" target="_self">Iniciar secion</a>
	</main>
	<!--
